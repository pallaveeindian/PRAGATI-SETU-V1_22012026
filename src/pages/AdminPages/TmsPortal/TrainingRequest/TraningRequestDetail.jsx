...
export default function TrainingRequestDetail() {
  ...
  // Gradient for Training Request Detail page (matching Training Request List)
  const currentGradient = "linear-gradient(to bottom, rgb(5, 46, 22) 0%, rgb(20, 83, 45) 12%, rgb(22, 101, 52) 28%, rgb(21, 128, 61) 45%, rgb(22, 163, 74) 60%, rgb(34, 197, 94) 75%, rgb(74, 222, 128) 88%, rgb(187, 247, 208) 100%)";

  return (
    <div className="app-shell">
      <AdminHeader currentGradient={currentGradient} transparent={false} />
      <div className="content-area">
        <AdminSidebar
          activeMenu="Training Request List"
          setActiveMenu={() => {}}
          isCollapsed={navCollapsed}
          onToggleSidebar={() => setNavCollapsed((v) => !v)}
          fixed
        ...
        <div
          className="main-area"
          style={{ marginLeft: navCollapsed ? 72 : 250, minWidth: 0 }}
        >
          {/* <TopNav
          left={
              ...
              >
                ...
                <div style={{ marginLeft: "auto", display: "flex", gap: 8 }}>
                  ...
                  <button
                    ...
                    onClick={() =>
                      navigate("/admin/dashboard?section=training-requests")
                    }
                  >
                    Back
                  </button>
