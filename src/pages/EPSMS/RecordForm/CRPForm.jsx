...
export default function CRPForm() {
  ...
  // Fallback CLF Options data table when auto-fetch yields 404
  const fallbackClfOptions = [
    { srNo: 1, name: "Samradhi Mahila CLF", code: "001234567812" },
    { srNo: 2, name: "Prerna Mahila CLF", code: "002234567814" },
    { srNo: 3, name: "Unnati Mahila CLF", code: "003987654363" },
  ];
              ...
              <table className="fallback-clf-table">
                ...
                <tbody>
                  {fallbackClfOptions.map((clf) => (
                    <tr key={clf.code} className={clf_code === clf.code ? "selected-row" : ""}>
                      <td>{clf.srNo}</td>
                      <td>{clf.name}</td>
                      <td><span className="clf-code-badge">{clf.code}</span></td>
                      <td>
                        <button
                          type="button"
                          ...
                          onClick={() => {
                            ...
                            setClfError(""); // Clear error layout context once selected
                          }}
                        >
