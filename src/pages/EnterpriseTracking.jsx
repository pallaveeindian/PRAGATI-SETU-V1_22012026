      ...
      <main className="home-hero">
        <div className="about-section">
          <div className="about-left">
            <h1><span className="contrast-color-two" >Enterprise</span><span className="contrast-color-one">Tracking</span></h1>
            ...
            <div className="pragati-card">
              <p>
                The system enables tracking of existing enterprises, supports new
                enterprise planning, captures information on wage-employment
                interest, identifies challenges faced by entrepreneurs, and
                facilitates access to financial support through CIF fund linkage.
              </p>
            </div>
            <div className="pragati-card">
              <p>
                ...
                entrepreneurial activities, and ensure effective implementation of
                livelihood and enterprise development programs.
              </p>
            </div>
          </div>
