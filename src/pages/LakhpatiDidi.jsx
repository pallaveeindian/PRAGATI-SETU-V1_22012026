      ...
      <main className="home-hero">
        <div className="about-section">
          <div className="about-left">
            <h1><span className="contrast-color-two" >Lakhpati</span> <span className="contrast-color-one">Didi </span> </h1>
            <div className="pragati-card">
              <p>
                ...
                livelihoods through sustainable farming, non-farm activities, and
                enhanced living standards. It leverages SHGs as platforms for
                collective action, financial literacy, skill development, and
            ...
            <div className="pragati-card">
              <p>
                Livelihood diversification is promoted through integrated farming,
                artisan, and sectoral clusters, combining training, market
                development, and common facility centers, with up to Rs. 5 crore
                support per cluster and convergence with other government
                programs.
              </p>
            </div>
          </div>
