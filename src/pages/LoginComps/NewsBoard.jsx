...
export default function NewsBorad({ module = "tms", theme = "blue" }) {
    ...
    >
      <div className="news-header">
        <div>
          ...
          <h3>{lang === "hi" && activeModule.title_hi ? activeModule.title_hi : activeModule.title}</h3>
        </div>
      ...
      <p className="news-subtitle">
        {lang === "hi" && activeModule.subtitle_hi ? activeModule.subtitle_hi : activeModule.subtitle}
      </p>
      ...
      <div className="news-list" ref={scrollRef}>
        {(activeModule.items || []).map((item) => (
          <article key={item.id} className="news-item">
            ...
            <h4>{lang === "hi" && item.title_hi ? item.title_hi : item.title}</h4>
            <p>{lang === "hi" && item.description_hi ? item.description_hi : item.description}</p>
          </article>
        ))}
      </div>
