  ...
  const [applications, setApplications] = useState([
    {
      ...
      village: "Beli",
      docs: {
        idProof: "id_proof_sita.pdf",
        incomeProof: "income_proof_sita.pdf",
        voVerification: "vo_verification_sita.pdf",
        clfVerification: "clf_verification_sita.pdf",
      },
    },
    {
      id: "MCCY1002",
      ...
      village: "Sissendi",
      docs: {
        idProof: "id_proof_geeta.pdf",
        incomeProof: "income_proof_geeta.pdf",
        voVerification: "vo_verification_geeta.pdf",
        clfVerification: "clf_verification_geeta.pdf",
      },
    },
  ]);
    ...
    tableHTML += `
      <tr>
        <th colspan="${headers.length}" style="background-color: #1F3C88; color: #FFFFFF; font-size: 24px; font-weight: bold; text-align: center; height: 50px;">
          Pragati Setu - MCCY Application List
        </th>
      </tr>`;
  ...
  return (
    <div style={{ width: "100%", position: "relative" }}>
      ...
      <div style={styles.filterCard}>
        ...
        >
          <h2 style={{ color: "#6d2a00", margin: 0 }}>
        ...
        <div style={styles.tabContainer}>
          ...
          <button
            style={
              activeTab === "FORWARDED" ? styles.activeTab : styles.inactiveTab
            }
          ...
          <button
            style={
              activeTab === "REVERTED" ? styles.activeTab : styles.inactiveTab
            }
          ...
          <button
            style={
              activeTab === "REJECTION" ? styles.activeTab : styles.inactiveTab
            }
      ...
      <div style={styles.TablefilterCard}>
        <div style={{ overflowX: "auto" }}>
          ...
          >
            <thead>
              <tr>
                <th style={styles.mccyth}>Sr No.</th>
                <th style={styles.mccyth}>Member & Guardian</th>
                <th style={styles.mccyth}>Enterprise & Loan</th>
                <th style={styles.mccyth}>SHG / VO Details</th>
                <th style={styles.mccyth}>Location Details</th>
                <th style={styles.mccyth}>App ID & Status</th>
                <th style={styles.mccyth}>Action</th>
              </tr>
            </thead>
            <tbody>
              {displayedApps.map((app, index) => {
                const actionBtnText =
                  app.status === "PENDING" || app.status === "REVERTED_BY_DMMU"
                    ? "View & Verify"
                    : "View";
                ...
                if (app.status === "REVERTED_BY_DMMU")
                  statusLabel = "Reverted by DMMU";
                ...
                return (
                  ...
                  >
                    <td style={styles.td}>
                      <strong style={{ color: "#6D2A00" }}>{index + 1}</strong>
                    </td>
                    ...
                    <td style={styles.td}>
                      ...
                      {app.district} |{" "}
                      <span style={{ color: "#666" }}>Block:</span> {app.block}
                      <br />
                      <span style={{ color: "#666" }}>GP:</span> {app.panchayat}{" "}
                      | <span style={{ color: "#666" }}>Vill:</span>{" "}
                      {app.village}
                    </td>
...
const getDotStyle = (status) => {
  ...
  if (status === "FORWARDED")
    return { ...baseStyle, backgroundColor: "#0284c7" };
  if (status === "REVERTED")
