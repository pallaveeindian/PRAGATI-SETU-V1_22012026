      ...
      <main className="home-hero">
        <div className="about-section">
          <div className="about-left">
            <h1><span className="contrast-color-two">Monitoring and</span><span className="contrast-color-one"> Anlytics</span></h1>
            <div className="pragati-card">
              <p>
                The <strong>UPSRLM Progress Tracking Dashboard</strong> serves as
                a comprehensive digital monitoring and analytics platform that
                brings together programme data from districts and blocks into a
                unified visual interface. It is designed to enhance transparency,
                consistency, and speed in reviewing mission progress by replacing
                scattered manual records and informal reporting methods with a
                structured, technology-driven system.
              </p>
            </div>
            <div className="pragati-card">
              <p>
                ...
                quickly assess performance trends, detect gaps, and take informed
                corrective actions. Overall, it strengthens governance efficiency,
                promotes data reliability, and supports timely, evidence-based
