...
export default function SmmuCreateTrainingPlan() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      await TMS_API.trainingPlans.create(payload);
      ...
      console.error("Failed creating training plan", error);

      setMessage({
        type: "error",
        text: "Failed to create training plan.",
      });
    } finally {
      setSaving(false);
    }
            ...
            <main className="smmu-main-content">
              ...
              <div className="page-header">
                <div className="form-card">
                  <h1 className="page-title">Add NEW Training Module</h1>
                </div>
              </div>
                  ...
                  <div className="form-grid">
                    ...
                    <div className="form-group full-width">
                      ...
                      <input
                        ...
                        placeholder="Please enter the name of New Training Module here"
                    ...
                    <div className="form-group">
                      <label className="form-label">
                        What will be the Duration of this Module?
                      </label>
                      ...
                      <input
                        ...
                        name="no_of_days"
                        className="form-input"
                        placeholder="Please enter the duration of the module in days"
