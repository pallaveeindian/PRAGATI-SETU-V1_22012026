      ...
      <main className="home-hero">
        <div className="about-section">
          <div className="about-left">
            <h1><span className="contrast-color-two" >Training</span><span className="contrast-color-one"> Management</span></h1>
            <div className="pragati-card">
              <p>
                ...
                complete lifecycle of trainings under <strong>UPSRLM</strong>. It
                supports creation and approval of training plans, training
                requests and batches, beneficiary and trainer management,
                registration of training centers, biometric eKYC and daily
                attendance tracking, processing of training payments, and training
                closure with report and certificate generation.
              </p>
            </div>
            <div className="pragati-card">
              <p>
                ...
                <strong>SMMU</strong>, Training Partners, and Master Trainers, and
                integrates data from <strong>LokOS</strong>, SHG/Beneficiary
            ...
            <div className="pragati-card">
              <p>
                ...
                governance transparency, prevents unauthorized access, and ensures
                efficient digital operations across all administrative levels.
              </p>
            </div>
          </div>
