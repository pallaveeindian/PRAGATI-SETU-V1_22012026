      ...
      <main className="home-hero">
        <div className="about-section">
          <div className="about-left">
            <h1><span className="contrast-color-two">User</span><span className="contrast-color-one"> Manual</span></h1>
            <div className="pragati-card">
              <p>
                ...
                <strong>BMS</strong>, <strong>TMS</strong>, <strong>LDMS</strong>,
                and <strong>EMS</strong>. Users begin by opening the official
                Pragati Setu login page through a supported web browser and
                selecting the required application module based on their
                operational needs.
              </p>
            </div>
            <div className="pragati-card">
              <p>
                ...
                <strong>DMMU</strong>, <strong>BMMU</strong>, and other designated
                roles. This ensures that each user gains access only to the
                features and data permitted under their responsibility and
            ...
            <div className="pragati-card">
              <p>
                ...
                registered <strong>Username</strong> and <strong>Password</strong>{" "}
                credentials and click the <strong>Log In</strong> button. Upon
                successful authentication, the system redirects the user to the
                respective dashboard. This structured login workflow enhances
                security, prevents unauthorized access, and ensures controlled and
                efficient digital operations across all administrative tiers.
              </p></div>
          </div>
