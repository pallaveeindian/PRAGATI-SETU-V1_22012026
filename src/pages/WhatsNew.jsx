      ...
      <main className="home-hero">
        <div className="about-section">
          <div className="about-left">
            <h1><span className="contrast-color-two">What's</span><span className="contrast-color-one"> New</span></h1>
            ...
            <div className="pragati-card">
              <p>
                ...
                field workers and community members collect and manage enterprise
                information in a simple digital format, replacing paper registers
                and scattered manual records. This approach makes data collection
                faster, more accurate, and easier to monitor across administrative
                levels.
              </p>
            </div>
            <div className="pragati-card">
              <p>
                ...
                livelihood initiatives, acting as a digital bridge for sustainable
                enterprise development and economic empowerment.
              </p>
            </div>
          </div>
